...
$contracts = [
  ...
  [
    'Endpoint' => '/api/v1/users',
    'Method' => 'POST',
    'ParamsBody' => '{ "name":"Marlin", "email":"Marlin Lisye Palilu@gmail.com", "password":"123456", "role":"user" }',
    'Response' => '{ "success":true, "message":"User berhasil ditambahkan" }'
  ],
  [
    'Endpoint' => '/api/v1/users/{id}',
    'Method' => 'PUT',
    'ParamsBody' => '{ "name":"Oyan Update", "email":"Oyan @gmail.com", "role":"admin" }',
...
<body>
  ...
  <p>Versi API: v1.0.0 | Dibuat oleh <strong>Marlin Lisye Palilu</strong> di Praktikum Pemrograman Jaringan © <?= date('Y') ?></p>
</body>
</html>